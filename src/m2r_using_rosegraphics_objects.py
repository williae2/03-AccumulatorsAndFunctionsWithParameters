...
#                turtle and rectangle
#
#          -- Write the names of three METHODs that Circle objects have:
#                .fill_color, .attach_to, radius
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                color, radius, centerpoint
#
#     f. What does a RoseWindow RENDER method do?
#            It creates a specific window with specific dimensions to allow objects to be drawn
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When one wants to end the code def. It allows for he rest of the code to continue forth
#
