...
def run_test_sum_of_digits():
    ...
    expected = 19
    answer = sum_of_digits(1945)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 31
    answer = sum_of_digits(296437)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 8
    answer = sum_of_digits(206)
...
def run_test_fancy_sums_of_digits():
    ...
    expected = 123604
    answer = fancy_sums_of_digits(34)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def fancy_sums_of_digits(n):
    ...
    ####################################################################
    # ------------------------------------------------------------------
    answer_x = sum_of_digits(n ** 1000)
    answer_y = sum_of_digits(n ** 999)
    answer = sum_of_digits(answer_x ** answer_y)
    return answer
